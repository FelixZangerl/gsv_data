...
handel_vs_vj$time <- lubridate::ceiling_date(handel_vs_vj$time, unit="week")
...
gastro_vs_vj <- as.numeric(gastro_vs_vj)
...
gastro_vs_vj$time <- lubridate::ceiling_date(gastro_vs_vj$time, unit="week")
